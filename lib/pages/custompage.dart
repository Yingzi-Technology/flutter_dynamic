...
class YZDynamicCustomPage extends YZDynamicBasePage {
  ...
  YZDynamicCustomPage(this.pageConfig,
    {
      this.preConfig
...
class _YZDynamicCustomPageState extends YZDynamicBaseState<YZDynamicCustomPage> {
  ...
  void initState() {
    ...
    if (_rootWidgetJson != null && _rootWidgetJson['widgetName'] == 'Scaffold') {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _rootWidget = YZDynamicCommon.buildWidget(_rootWidgetJson, context: context);

    assert(_rootWidget != null, 'Error: rootWidget can not be null!');
    if (_rootWidget == null) return Text('rootWidget is null!');
