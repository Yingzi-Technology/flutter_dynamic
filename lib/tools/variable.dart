...
class YZDynamicVariableUtil {
    ...
    if (context != null) {
      ...
      for (Match m in matches2) {
        ...
        if (subvariables.length == 1) {
          value = YZDynamicBasePage.getVariable(context, subvariables[0],
  ...
  static void assignmentVariable(String rawString,
    ...
    dynamic value = YZDynamicVariableUtil.getValueOfVariable(valueBody,
        state: state, context: context, localVariables: localVariables);

    setObjectWithVariablePatten(key, value,
  ...
  static dynamic getValueOfVariable(String valueBody,
    ...
    if (YZDynamicVariableUtil.isVariable(valueBody)) {
      ...
      value = YZDynamicVariableUtil.convertStringWithVariablePatten(valueBody,
          context: state?.context,
          localVariables: localVariables,
          state: state);
  ...
  static void setObjectWithVariablePatten(
    ...
    if (context != null) {
      ...
      for (Match m in matches2) {
        ...
        if (subvariables.length == 1) {
          YZDynamicBasePage.setVariable(
              context, subvariables, assinment, YZDynamicVariableType.widget);
        } else {
          YZDynamicBasePage.setVariable(context, subvariables, assinment,
              YZDynamicVariableType.widgetProperties);
        }
      }
